    ...
    emergencyServices: [
      {
        ...
        address: 'G/N Block, BKC, Bandra East, Mumbai',
        phone: '022-66986666',
        capacity: 250,
      },
      {
      ...
      },
      {
        ...
        address: 'Near Asian Heart Institute, BKC, Mumbai',
        phone: '022-26504008',
      },
      {
        id: 'mum_fire_1',
        type: 'fire_station',
        name: 'BKC Fire Station (Mumbai Fire Brigade)',
        latitude: 19.0678,
        longitude: 72.8614,
        distanceMeters: 920,
        distanceFormatted: '920 m',
        address: 'Plot C-65, G Block, BKC, Mumbai',
        phone: '022-26590101',
      },
      {
        id: 'mum_shelter_1',
        ...
        address: 'MMRDA Grounds, Elevated Complex, BKC',
        phone: '022-26594000',
        capacity: 1200,
      },
    ],
    ...
    emergencyServices: [
      {
        ...
        address: 'Delhi Gate, Jawaharlal Nehru Marg, New Delhi',
        phone: '011-23233000',
        capacity: 1500,
      },
      {
      ...
      },
      {
        ...
        address: 'Shaheed Bhagat Singh Marg, CP, New Delhi',
        phone: '011-23363385',
      },
      {
        id: 'del_fire_1',
        type: 'fire_station',
        name: 'Connaught Place Fire Station (Delhi Fire Service)',
        latitude: 28.6295,
        longitude: 77.2210,
        distanceMeters: 800,
      ...
      },
      {
        id: 'del_shelter_1',
        type: 'shelter',
        name: 'NDMC Community Evacuation Centre',
        latitude: 28.6310,
        longitude: 77.2150,
        distanceMeters: 1100,
        distanceFormatted: '1.1 km',
        address: 'Palika Kendra Complex, Sansad Marg, New Delhi',
        phone: '011-23742747',
        capacity: 2000,
      },
    ],
    ...
    emergencyServices: [
      {
        ...
        address: 'No. 36 & 36A, Velachery Main Rd, Chennai',
        phone: '044-46805555',
        capacity: 200,
      },
      {
        ...
        address: '1, Radial Rd, Dandeeswaram, Pallikaranai, Chennai',
        phone: '044-66300300',
        capacity: 350,
      },
      {
        ...
        address: 'Velachery Bypass Rd, Dhandeeswaram, Chennai',
        phone: '044-23452631',
      },
      {
        id: 'che_fire_1',
        type: 'fire_station',
        name: 'Velachery Fire and Rescue Station',
        latitude: 12.9770,
        longitude: 80.2160,
        distanceMeters: 350,
        distanceFormatted: '350 m',
        address: 'Near Velachery Bus Terminus, Chennai',
        phone: '044-22440101',
      },
      {
        id: 'che_shelter_1',
        ...
        distanceMeters: 800,
        distanceFormatted: '800 m',
        address: 'Zone 13 Community Hall, 100 Feet Rd, Velachery',
        phone: '044-25619206',
        capacity: 1500,
      },
    ],
